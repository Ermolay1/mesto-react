...
function NewCardPopup({ isOpen, isLoading, onNewCard, onClose } ){
    ...
    return (
        <PopupWithForm
            ...
            <input id="popup-img" className="popup__input popup__input_type_value-name" type="text" name="name"
            ...
            <input id="popup-link" className="popup__input popup__input_type_value-link" name="link"
