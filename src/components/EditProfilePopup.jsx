...
function EditProfilePopup({ isOpen, isLoading, onUpdateUser, onClose }) {
    ...
    return (
        <PopupWithForm
            ...
            <input id="popup-name" className="popup__input popup__input_value_name " type="text" name="name"
            ...
            <input id="popup-description" className="popup__input popup__input_value_description" type="text" name="about"
